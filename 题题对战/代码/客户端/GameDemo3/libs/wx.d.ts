interface CanvasContext {
  ...
  interface _showProgressBarObject {
    /**
     * 提示的内容
     */
    title: string;
  ...
  declare namespace wx {
    export function createUserInfoButton(..._): any;
    export function onShareAppMessage(..._) : any;
    /**
     * 批量添加卡券。
     */
     ...
     */
    export function getUserInfo(_): void;
     ...
     */
    export function setStorageSync(key: string, _): void;
     ...
     */
    export function showProgressBar(object: _showProgressBarObject): void;
     ...
     * 显示当前页面的转发按钮
     */
    export function showShareMenu(..._): void;
