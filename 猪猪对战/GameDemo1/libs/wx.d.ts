...
declare namespace wx {
  ...
  export function getLaunchOptionsSync(..._): any;
  export function shareAppMessage(..._): any;
  export function onShow(..._): any;
  export function offShow(..._): any;
  export function showToast(..._): any;
  /**
   * 批量添加卡券。
   */
